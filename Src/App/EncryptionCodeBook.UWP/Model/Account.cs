...
namespace encryption_code_book.Model
{
    public class Account
    {
        ...
        public const string EncryptionCodeBookVersion = "私密密码本 3";

        public static string Serializer()
        {
            string str = EncryptionCodeBookVersion + "\r\n" +
        ...
        public const int ConfirmKeyLength = 1024;
        public const int ApplicationHeaderLength = ConfirmKeyLength;
