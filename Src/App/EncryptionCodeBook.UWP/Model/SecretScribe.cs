...
namespace encryption_code_book.Model
{
    public class EncryCodeSecretScribe
    {
        ...
        {
            Encry = Account.EncryptionCodeBookVersion;
        }

        public EncryCodeSecretScribe(string name, byte[] comfirmKey)
        {
            Name = name;
    ...
    public class SecretScribe : KeySecret
    {
        ...
        public async Task Read()
        {
            try
            {
                ...
                ConfirmKey = encryCodeSecretScribe.ComfirmKey;
        ...
        public bool Comfirm()
        {
            return _stringEncryption.Confirm(ConfirmKey, Key);
        }

        [JsonIgnore]
        private readonly StringEncryption _stringEncryption = new StringEncryption();
